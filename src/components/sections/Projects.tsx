  ...
  return (
    <section id="projects" className="py-32">
      <div className="container-custom">
        <div className="mb-16">
          <Badge className="border-white/10 bg-white/5 px-5 py-2 text-sm font-medium rounded-full">Featured Projects</Badge>
        ...
        <div className="space-y-24">
          ...
          <article className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="order-2 lg:order-1 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-4">
              <Image
